...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{./images/residuals_vs_fitted.png}
...
\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[width=\linewidth]{./images/neighborhood_predicted_vs_actualOLS.png}
...
\begin{figure}[h]
	\begin{tikzpicture}
		\begin{axis}[
			...
			\legend{With neighborhood booleans, Without neighborhood booleans}
		\end{axis}
	\end{tikzpicture}
...
\begin{minipage}[t]{0.47\textwidth}
	...
	\captionof{figure}{Random Forest predicted vs actual \\ values, no neighborhood booleans}
...
\begin{minipage}[t]{0.47\textwidth}
	...
	\captionof{figure}{Neural Network predicted vs actual \\ values, without neighborhood booleans}
	\label{fig:nn-scatterplot-test-no-neighborhood}
\end{minipage}
\begin{minipage}[t]{0.47\textwidth}
	\centering
	\includegraphics[width=\linewidth]{./images/neighborhood_scatterNN.png}
	\captionof{figure}{Neural Network predicted vs actual \\ values, with neighborhood booleans}
...
\begin{figure}[h]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\legend{No neighborhood booleans, With neighborhood booleans}
		\end{axis}
	\end{tikzpicture}
...
\begin{longtable}{l l l}
	...
	Lake View                                             & Example of a neighborhood variable.                         & boolean          \\
