...
#
#
# # Calculate IQR of residuals
# iqr = calculate_iqr(residuals)
#
# # Define bounds for outliers
# lower_bound = residuals.quantile(0.25) - 1.5 * iqr
# upper_bound = residuals.quantile(0.75) + 1.5 * iqr
...
x_1 = sm.add_constant(x_1.drop(["school1", "deposit", "footageplural"], axis=1))
